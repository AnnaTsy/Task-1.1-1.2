/*   Цивинская Анна, задание 1.1, 1.2 и 1.3  */
...
for (var i = 1; i < dots.length; i++) {
  if (dots[i][0] == 0 && dots[i][1] == 0) {
    i++;
    pict.moveTo(150 * (1.5 - dots[i][0]), 150 * (1.5 - dots[i][1]));
  } else pict.lineTo(150 * (1.5 - dots[i][0]), 150 * (1.5 - dots[i][1]));
}
pict.closePath();
pict.stroke();
